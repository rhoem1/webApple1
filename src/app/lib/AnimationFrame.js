...
export default class AnimationFrame {
    ...
    constructor(options = {}) {
        ...
        this.frameRate = options.frameRate || FRAME_RATE
        this._frameLength = 1000 / this.frameRate
        this._isCustomFrameRate = this.frameRate !== FRAME_RATE
     ...
     */
    static shim(options) {
        const animationFrame = new AnimationFrame(options)
     ...
     * @api public
     */
    static get navigationStart() {
        return AnimationFrame.now()
    }
    ...
    static get hasNative() {
        return hasNativeImplementation;
    }
